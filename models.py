...
class Settings(db.Model):
    ...
    no_execute_pairs     = db.Column(db.Text, default='["XRP-USDT", "DOGE-USDT", "ETH-USDT"]')  # JSON list: signal fires but NO live order placed
    ...
    def to_dict(self):
        return {
            ...
            'no_execute_pairs':       self.no_execute_pairs or '["XRP-USDT", "DOGE-USDT", "ETH-USDT"]',
