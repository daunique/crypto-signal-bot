...
BUILD_VERSION = "2026-07-26-straddle-execution-and-invert-setting-1"
...
class Settings(BaseSettings):
    ...
    # If True, the direction *recorded and displayed* as the strategy's
    # signal is flipped from what it actually detected (requested
    # 2026-07-25). Execution is unaffected either way: every qualifying
    # signal opens BOTH a HIGHER and a LOWER position (requested
    # 2026-07-26, see engine.py's execute_straddle) regardless of this
    # setting -- so this only changes labeling/display, not what gets
    # traded.
